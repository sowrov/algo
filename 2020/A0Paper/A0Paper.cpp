...
namespace otocoder {
    ...
    int run_test_case(int casenum) {
        ...
        case 0: {
            ...
            string received_ = A0Paper().canBuild(vector<int>(A, A + (sizeof A / sizeof A[0])));
    ...
    bool run_full_test() {
        ...
        for (int i=0; i<testCase; i++) {
            ...
            clock_t start_           = clock();
            string received_ = A0Paper().canBuild(A);
        ...
        if (testCase == 0) {
            ...
            std::ofstream ofs("A0Paper.st", std::ios_base::app);
