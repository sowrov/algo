#ifndef UTIL_ALGO_STRINGTOKENIZER_H_
#define UTIL_ALGO_STRINGTOKENIZER_H_
...
public:
    ...
    int countTokens() {
        ...
        for (int i = 0; i <= length; i++) {
            if (i == length ||
                    (i < length && String::isInString(this->currentDelim, this->str.at(i)))) {
    ...
    bool hasMoreTokens() {
        ...
        if (!this->returnDelims) {
            for (int i = 0; i<this->str.length(); i++) {
                ...
                if (!String::isInString(this->currentDelim, this->str.at(i))) {
                        return true;
                    }
            }
            return false;
    ...
    std::string nextToken() {
        ...
        if (!this->returnDelims) {
            ...
            for (; i<this->str.length(); i++) {
                ...
                if (!String::isInString(this->currentDelim, this->str[i])) {                        
                        break;
                    }
            }
            this->str.erase(0, i);
...
#endif //UTIL_ALGO_STRINGTOKENIZER_H_
